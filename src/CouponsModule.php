...
{
    public function name(): string { return 'table-coupons'; }
    public function table(): string { return 'coupons'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_coupons_tenant_active', 'idx_coupons_tenant_id', 'ux_coupons_tenant_code_ci' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_coupons_tenant_active', 'idx_coupons_tenant_id', 'ux_coupons_tenant_code_ci' ],
            'foreignKeys' => [ 'fk_coupons_tenant' ],
        ];
    }
}
