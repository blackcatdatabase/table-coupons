...
final class CouponDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'starts_at' => 'startsAt', 'ends_at' => 'endsAt', 'max_redemptions' => 'maxRedemptions', 'min_order_amount' => 'minOrderAmount', 'applies_to' => 'appliesTo', 'is_active' => 'isActive', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
    /** @var string[] */
    private const BOOL_COLS   = [ 'is_active' ];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'max_redemptions' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'currency', 'ends_at', 'min_order_amount', 'applies_to', 'OR' ];
