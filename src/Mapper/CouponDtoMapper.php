...
namespace BlackCat\Database\Packages\Coupons\Mapper;

use BlackCat\Database\Packages\Coupons\Dto\CouponDto;
use BlackCat\Database\Packages\Coupons\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO CouponDto:
...
final class CouponDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'max_redemptions' ];
    /** @var string[] */
    private const FLOAT_COLS  = [ 'value', 'min_order_amount' ];
    /** @var string[] */
    private const JSON_COLS   = [ 'applies_to' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'starts_at', 'ends_at', 'created_at', 'updated_at' ];
    /** @var string[] */
     ...
     * @return CouponDto
     */
    public static function fromRow(array $row): CouponDto
    {
        /** @var CouponDto */
    ...
    public static function fromRowOrNull(?array $row): ?CouponDto
    {
     ...
     */
    public static function toRow(CouponDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(CouponDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(CouponDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(CouponDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,CouponDto>
     */
