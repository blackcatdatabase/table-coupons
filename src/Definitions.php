...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'code', 'code_ci', 'type', 'value', 'currency', 'starts_at', 'ends_at', 'max_redemptions', 'min_order_amount', 'applies_to', 'is_active', 'created_at', 'updated_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'code_ci' ], [ 'tenant_id', 'id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'max_redemptions' ]; }
    ...
    public static function generatedColumns(): array { return [ 'code_ci' ]; }
