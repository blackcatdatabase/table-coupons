...
- Pkg folder: [packages\coupons](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\coupons)
...
graph LR
  ...
  coupons -->|FK| tenants["tenants"]:::link
  coupon_redemptions["coupon_redemptions"]:::inbound -->|FK| coupons
...
- Inbound (relies on this): "coupon_redemptions"
...
| [040_views_modules.mysql.sql](schema/modules/blackcat-commerce/040_views_modules.mysql.sql) | mysql |
| [040_views_modules.postgres.sql](schema/modules/blackcat-commerce/040_views_modules.postgres.sql) | postgres |
...
| [040_views_modules.mysql.sql](schema/modules/blackcat-commerce/040_views_modules.mysql.sql) | mysql | package |
| [040_views_modules.postgres.sql](schema/modules/blackcat-commerce/040_views_modules.postgres.sql) | postgres | package |
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package coupons -Apply
